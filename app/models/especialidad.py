...
class Especialidad(db.Model):
    ...
    tipo_especialidad = db.relationship('TipoEspecialidad', back_populates='especialidades')
    orientaciones = db.relationship('Orientacion', back_populates='especialidad', lazy=True)